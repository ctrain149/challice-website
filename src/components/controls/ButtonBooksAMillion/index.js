...
import BooksAMillionLogo from '../../../../public/books-a-million-logo.png';

import styles from './index.module.scss';

export default function ButtonBooksAMillion({ disabled = false, href = '' }) {
  const ratio = 16;
  ...
  return (
    <div className={styles.ButtonBooksAMillion} ref={buttonRef}>
      <button
